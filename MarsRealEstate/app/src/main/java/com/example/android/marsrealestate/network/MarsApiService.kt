...
enum class MarsApiFilters(val value: String) { SHOW_RENT("rent"), SHOW_BUY("buy"), SHOW_ALL("all") }
...
object MarsApi {
    val retrofitService: MarseApiService by lazy {
        retrofit.create(MarseApiService::class.java)
    }
}
